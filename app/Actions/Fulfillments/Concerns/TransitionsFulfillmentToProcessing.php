...
namespace App\Actions\Fulfillments\Concerns;
...
trait TransitionsFulfillmentToProcessing
{
    protected function transitionToProcessing(
        ...
        app(AppendFulfillmentLog::class)->handle(
            ...
            'Fulfillment started',
            $this->buildProcessingContext($actor, $actorId, $meta)
        );
     ...
     */
    protected function buildProcessingContext(string $actor, ?int $actorId, array $meta): array
    {
        return array_filter([
            'action' => 'start',
            'actor' => $actor,
